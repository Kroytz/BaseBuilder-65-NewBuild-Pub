...
#define BURN_LOOP_TIME 0.5

new g_bitsBurn

new const SPR_FIRE[] = "sprites/flame.spr"
new g_iSprFire
...
public plugin_init()
{
	...
	RegisterHam(Ham_Spawn, "player", "HamF_Player_Spawn", 1)
...
public Task_BurnLoop(taskid)
{
    ...
    flHealth -= zp_get_user_zombie(id) ? 30.0:3.0
